            ...
            <View style={styles.container}>
                <View style={styles.form}>
                    ...
                    <KeyboardAvoidingView behavior={'padding'}>
                        ...
                        <TextInput style={styles.input} placeholderTextColor={'white'} placeholder={'Designation'} />
                        <TextInput style={styles.input} placeholderTextColor={'white'} placeholder={'Qualification'} />
                        <TextInput style={styles.input} placeholderTextColor={'white'} placeholder={'License Number'} />
                        <TextInput style={styles.input} placeholderTextColor={'white'} placeholder={'Hospital/Clinic'} />
                        <TextInput style={styles.input} placeholderTextColor={'white'} placeholder={'Secret Key'} />
